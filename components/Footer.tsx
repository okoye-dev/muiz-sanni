...
const Footer: FC = () => {
  ...
  return (
    <div className="flex w-fit flex-col gap-10 px-6 pb-4 pt-20 md:px-20 md:pt-32 lg:px-32 lg:pb-10">
      <div className="flex w-fit flex-col justify-center gap-10 md:flex-row md:items-center md:gap-0">
        ...
        <Link
          href={"/"}
          className="flex h-40 w-40 items-center justify-center rounded-full border-2 border-white/30 duration-300 hover:rotate-45 hover:bg-white/5 md:mr-[5vw] md:h-48 md:min-w-48 lg:h-60 lg:min-w-60 xl:h-72 xl:min-w-72"
        >
          <Image
            src={arrow}
            alt="go"
